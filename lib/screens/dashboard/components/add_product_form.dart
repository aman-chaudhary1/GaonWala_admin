                  ...
                  Expanded(child: Consumer<DashBoardProvider>(
                    builder: (context, dashProvider, child) {
                      return CustomDropdown(
                        ...
                        onChanged: (newValue) {
                          if (newValue != null) {
                            //TODO: should complete call  filterSubcategory(compleyte)
                  ...
                  Expanded(child: Consumer<DashBoardProvider>(
                    builder: (context, dashProvider, child) {
                      return CustomDropdown(
                        ...
                        onChanged: (newValue) {
                          if (newValue != null) {
                            //TODO: should complete call filterBrand(complete)
                    ...
                    child: Consumer<DashBoardProvider>(
                      builder: (context, dashProvider, child) {
                        return CustomDropdown(
                          ...
                          onChanged: (newValue) {
                            if (newValue != null) {
                              //TODO: should complete call filterVariant(compleyte)
                    ...
                    onPressed: () {
                      ...
                      if (context
                        ...
                        context
                            .dashBoardProvider.addProductFormKey.currentState!
                            .save();
                        //TODO: should complete call submitProduct(compleyte)
