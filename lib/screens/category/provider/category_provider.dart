...
class CategoryProvider extends ChangeNotifier {
  ...
  //TODO: should complete addCategory(complete)
  addCategory() async {
    try {
  ...
  //TODO: should complete submitCategory(complete)
  ...
  //TODO: should complete deleteCategory(complete)
  deleteCategory(Category category) async {
    ...
    try {
      ...
      Console.log("category Deletedfff");
